...
leveldb_command_base = "cgexec -g memory:10 -- ./db_bench --benchmarks=readtrace --use_existing_db=1 \
                        --memory_size={} --cache_size={} --output=statictest/{}.latency --db=/nvme/leveldb3 \
