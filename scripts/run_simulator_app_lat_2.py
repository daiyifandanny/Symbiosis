...
result_dir = working_dir + "/results/miss_cost_p2"
...
memory_sizes = [0.05, 0.1, 0.15, 0.2, 0.25, 0.3, 0.35, 0.4, 0.45, 0.5, 0.55, 0.6, 0.65, 0.7, 0.75, 0.8, 0.85, 0.9, 0.95, 1]
memory_sizes = [0.5]
    ...
    for miss_cost in miss_costs:
        for memory_size in memory_sizes:
            for ratio in ratios:
                ...
                # if memory_size > 0.5:
                #     pc_size_list.append(0.5 / memory_size)
                for pc_size in pc_size_list:
                    ...
                    simulator_command = simulator_command_base.format(target, memory_size, pc_size, miss_cost, ratio, distribution, output_filename)
